...
export class CreateProgramacionDto {
  ...
  @IsNumber({ maxDecimalPlaces: 6 }, { message: 'horaInicio debe ser un número decimal (ej: 21.0833 para las 21:05)' })
  @Min(0, { message: 'La hora de inicio no puede ser negativa' })
  @Max(23.9999, { message: 'La hora de inicio no puede superar las 23:59' })
  horaInicio: number;

  @IsNumber({ maxDecimalPlaces: 6 }, { message: 'horaFin debe ser un número decimal (ej: 22.0833 para las 22:05)' })
  @Min(0, { message: 'La hora de fin no puede ser negativa' })
  @Max(47.9999, { message: 'La hora de fin no puede superar las 47:59 (máx 24h desde inicio)' })  // ← CAMBIO
  horaFin: number;

  @IsNumber({ maxDecimalPlaces: 6 }, { message: 'duracionHoras debe ser un número decimal' })
  @Min(0.0001, { message: 'La duración debe ser mayor que 0' })
  @Max(24, { message: 'La duración no puede superar 24 horas' })
  duracionHoras: number;

  @IsNumber({ maxDecimalPlaces: 4 }, { message: 'potenciaW debe ser un número decimal' })
